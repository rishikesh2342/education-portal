        ...
        <div class="row align-items-stretch">
          ...
          <div class="col-lg-4 col-md-6 mb-5">
            <div class="post-entry-1 h-100 person-1 teal">
                ...
                <img src="<?php echo TEMPLATE_PATH;?>default/images/person_1.jpg" alt="Image"
                 class="img-fluid">
          ...
          <div class="col-lg-4 col-md-6 mb-5">
            <div class="post-entry-1 h-100 person-1 yellow">
                ...
                <img src="<?php echo TEMPLATE_PATH;?>default/images/person_2.jpg" alt="Image"
                 class="img-fluid">
          ...
          <div class="col-lg-4 col-md-6 mb-5">
            <div class="post-entry-1 h-100 person-1 red">
                ...
                <img src="<?php echo TEMPLATE_PATH;?>default/images/person_3.jpg" alt="Image"
                 class="img-fluid">
          ...
          <div class="col-lg-4 col-md-6 mb-5">
            <div class="post-entry-1 h-100 person-1 green">
                ...
                <img src="<?php echo TEMPLATE_PATH;?>default/images/person_4.jpg" alt="Image"
                 class="img-fluid">
          ...
          <div class="col-lg-4 col-md-6 mb-5">
            <div class="post-entry-1 h-100 person-1 blue">
                ...
                <img src="<?php echo TEMPLATE_PATH;?>default/images/person_5.jpg" alt="Image"
                 class="img-fluid">
        ...
        <div class="row">
          <div class="col-lg-4">
            <div class="package text-center bg-white">
              <span class="img-wrap"><img src="<?php echo TEMPLATE_PATH;?>default/images/flaticon/svg/001-jigsaw.svg" alt="Image" class="img-fluid"></span>
          ...
          <div class="col-lg-4">
            <div class="package text-center bg-white">
              <span class="img-wrap"><img src="<?php echo TEMPLATE_PATH;?>default/images/flaticon/svg/002-target.svg" alt="Image" class="img-fluid"></span>
          ...
          <div class="col-lg-4">
            <div class="package text-center bg-white">
              <span class="img-wrap"><img src="<?php echo TEMPLATE_PATH;?>default/images/flaticon/svg/003-mission.svg" alt="Image" class="img-fluid"></span>
